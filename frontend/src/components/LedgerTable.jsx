...
import { formatDate, formatCurrency, formatTransactionType } from '../lib/format';
  ...
  return [
    ...
    },
    {
      ...
      cell: (info) => {
        ...
        return value ? (
          <span className="text-debit-600 font-medium">{formatCurrency(value)}</span>
        ) : (
          '–'
        );
      },
    ...
    },
    {
      ...
      cell: (info) => {
        const value = info.getValue();
        return value ? (
          <span className="text-credit-600 font-medium">{formatCurrency(value)}</span>
        ) : (
          '–'
        );
      },
    ...
    },
    {
      ...
      header: 'Balance',
      cell: (info) => (
        <span className="font-medium text-primary-900">{formatCurrency(info.getValue())}</span>
      ),
      meta: { align: 'right' },
      size: 100,
    },
